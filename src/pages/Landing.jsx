...
import {
  ...
  BookOpen, FileSpreadsheet, ChevronDown, Moon, Sun
} from 'lucide-react';
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-12">
                <Button onClick={handleLogin} className="bg-blue-500 hover:bg-blue-400 text-white px-7 py-3 text-sm font-semibold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25">
                  Pripojiť sa do beta <ArrowRight className="w-4 h-4" />
                </Button>
      ...
      <section id="cennik" className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            {[
              {
                name: 'Beta prístup', price: 'Zadarmo', period: '',
                desc: 'Pridajte sa ako prví',
                features: ['Plné Pro funkcie', 'Neobmedzené projekty', 'Všetky kalkulačky', 'AI analýza', 'Prioritná podpora', 'Lifetime early adopter výhody'],
                cta: 'Pripojiť sa do beta', highlight: true, badge: 'Teraz dostupné'
              },
              {
